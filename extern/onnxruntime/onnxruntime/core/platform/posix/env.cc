...
class PosixThread : public EnvThread {
 ...
 private:
  static void* ThreadMain(void* param) {
    ...
    ORT_TRY {
/* rampart: FreeBSD added to the exclusions -- this block assumes Linux
 * (glibc cpu_set_t + SYS_gettid); FreeBSD spells these pthread_np.h/cpuset_t
 * and has no gettid syscall. Thread affinity is an optimization ORT already
 * forgoes on Apple/Android/wasm/AIX; rampart never sets affinities. */
