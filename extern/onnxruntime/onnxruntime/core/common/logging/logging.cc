...
/* rampart: upstream's `#include "logging.h"` here is both unresolvable (the
 * header lives in the separated include tree) and redundant (already included
 * above as core/common/logging/logging.h) -- removed. */
#endif
