...
# rampart: the bare binary-dir include is wrapped in $<BUILD_INTERFACE:> --
# exporting coreml_proto (see the EXPORT note below) makes CMake reject a raw
# build-directory path in an exported target's INTERFACE_INCLUDE_DIRECTORIES.
...
if (NOT onnxruntime_BUILD_SHARED_LIB)
  # rampart: EXPORT added -- the static (BUILD_SHARED_LIB=OFF) build installs
  # onnxruntime_providers_coreml into the onnxruntimeTargets export set, and
  # CMake requires its linked coreml_proto to be exported too, else the
  # generate step fails: 'install(EXPORT "onnxruntimeTargets") includes
  # target "onnxruntime_providers_coreml" which requires target "coreml_proto"
  # that is not in any export set.'
  install(TARGETS coreml_proto EXPORT onnxruntimeTargets
